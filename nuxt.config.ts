...
const name = process.env.GITHUB_NAME || 'Lumirelle'
const login = process.env.GITHUB_LOGIN || 'lumirelle'
const website = process.env.WEBSITE_DOMAIN || 'https://releases.lumirelle.me'
